...
import main.java.ru.clevertec.check.Exception.QuantityException;
...
public class CsvReader {
    ...
    public static Product parseProduct(String line) throws QuantityException {
        ...
        try {
            ...
            LogError.getInstance().logErrorToCsv("INTERNAL SERVER ERROR0","result.csv");
